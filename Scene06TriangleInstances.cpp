...
void Scene06TriangleIndexed::Load(Renderer& renderer) {
	...
	SDL_GPUTransferBufferCreateInfo transferBufferCreateInfo = {
		...
		.size = (sizeof(PositionColorVertex) * 6) + (sizeof(Uint16) * 6),
	};
	...
	transferData[0] = PositionColorVertex{ -0.5f, -0.5f, 0.0f, 255, 255, 255, 255 }; // Bottom left 
	transferData[1] = PositionColorVertex{ 0.5f, -0.5f, 0.0f, 255, 255, 255, 255 }; // Bottom right
	transferData[2] = PositionColorVertex{ -0.5f,  0.5f, 0.0f, 255, 255, 255, 255 }; // Top left 
	...
	transferData[4] = PositionColorVertex{ 1, -1, 0, 255, 255, 255, 255 };
	transferData[5] = PositionColorVertex{ 0, 1, 0, 255, 255, 255, 255 };
	*/
...
void Scene06TriangleIndexed::Draw(Renderer& renderer) {
	...
	if (useIndexBuffer) {
		...
		renderer.DrawIndexedPrimitives(6, 8, 0, 0, 0);
	}
	else {
		renderer.DrawPrimitives(6, 8, 0, 0);
	}
