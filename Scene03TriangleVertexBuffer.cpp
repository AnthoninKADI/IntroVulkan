...
void Scene03TriangleVertexBuffer::Load(Renderer& renderer) {
    ...
    transferData[3] = PositionColorVertex{ 0.5f, -0.5f, 0.0f, 216, 255, 0, 255 }; // Bottom right
    transferData[4] = PositionColorVertex{ 0.5f,  0.5f, 0.0f, 255, 0, 197, 255 }; // Top right 
    transferData[5] = PositionColorVertex{ -0.5f,  0.5f, 0.0f, 255, 147, 255, 255 }; // Top left 
